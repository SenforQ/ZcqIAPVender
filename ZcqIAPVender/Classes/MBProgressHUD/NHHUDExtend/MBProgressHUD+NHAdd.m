...
+ (void)showSuccess:(NSString *)success toView:(UIView *)view {
    ...
    hud.customView = [[UIImageView alloc] initWithImage:[self imageWithBundleName:@"MBProgressHUD" imageName:@"success"]];
...
+ (void)showError:(NSString *)error toView:(UIView *)view {
    ...
    hud.customView = [[UIImageView alloc] initWithImage:[self imageWithBundleName:@"MBProgressHUD" imageName:@"error"]];
}
...
+ (UIImage *)imageWithBundleName:(NSString*)bundleName
    ...
    NSString* ZcqComponetsPath = [frameBundle pathForResource:@"ZcqIAPVender" ofType:@"bundle"];
    NSBundle* ZcqComponetsPathBundle = [NSBundle bundleWithPath:ZcqComponetsPath];
    NSString* ZCQImagesPathBundlePathStr = [ZcqComponetsPathBundle pathForResource:@"MBProgressHUD" ofType:@"bundle"];
